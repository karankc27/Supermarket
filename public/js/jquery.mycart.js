  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<button type="button" class="btn btn-default" id="save-cart">Place Order</button><button type="button" class="btn btn-default" data-dismiss="modal">Close</button>' +
    ...
    */
    ...
    $('#save-cart').click(function() {
       let final_price=ProductManager.getTotalPrice();
       let products=ProductManager.getAllProducts();

       $.ajax({
        'headers': { 'csrfToken': $('meta[name="csrfToken"]').attr('content') },
        'type': 'post',
        'data':  {
          "_token": "{{ csrfToken() }}",
          'products':products,
          'final':final_price,
          '_csrf': localStorage.getItem('__csrf')
